      ...
      {showDetail && (
        <div className="mt-9 text-left animate-detail-fade">
          ...
          <div className="text-center mt-8">
            <a
              href="/"
              className="inline-block text-[16px] text-[var(--color-gold)] bg-transparent border border-[rgba(212,175,120,0.3)] py-3 px-9 rounded-full cursor-pointer tracking-[0.1em] hover:bg-[rgba(212,175,120,0.08)] transition-colors no-underline"
            >
              自分も診断する
            </a>
          </div>
